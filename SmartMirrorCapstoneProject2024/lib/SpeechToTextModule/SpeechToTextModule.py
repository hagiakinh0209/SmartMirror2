...
class SpeechToText:
    def run(self, speechToTextListener):

        # A function which will be trigger and return a text when a phrase is complete
        self.speechToTextListener = speechToTextListener
        ...
        while True:
            try:
                ...
                if not data_queue.empty():
                    ...
                    input_features = processor(audio_np, sampling_rate=16000, return_tensors="tf").input_features
                    ...
                    for line in transcription:
                        print(line)
                    self.speechToTextListener(transcription[-1])
                    # Flush stdout.
